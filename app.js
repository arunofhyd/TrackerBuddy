...
// --- MODIFICATION: Updated particles to be more vibrant and colorful ---
...
// --- MODIFICATION: Updated 7th tap to trigger a confetti finale ---
function handleLogoTap() {
    ...
    if (state.logoTapCount >= 7) {
        state.logoTapCount = 0; // Reset counter
        ...
        // Calculate the position of the logo for the confetti origin
        const rect = DOM.appLogo.getBoundingClientRect();
        const origin = {
